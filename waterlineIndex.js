...
app.get('/detail/:_id', function (req, res) {
    ...
    app.models.Note.findOne({_id:req.params._id})
    ...
    app.models.Note.findOne({_id:req.params._id})
        .exec(function(err,art){
            ...
            if(art)
            {
                ...
                app.models.Note.update({id: req.params.id }, art, function(err,doc){
...
app.get('/delete/:_id',function(req,res){
    ...
    app.models.Note.findOne({_id:req.params._id})
        .exec(function(err,art){
            ...
            if(art)
            {
                app.models.Note.destory({_id:art._id},function(err,result){
...
app.post('/register', function (req, res) {
    ...
    app.models.User.findOne({ username: username }, function (err, user) {
        ...
        app.models.User.create(newUser,function (err, doc) {
...
app.post('/post', function (req,res) {
    ...
    app.models.Note.create(note,function(err,doc){
...
app.get('/profile/:username', function (req, res) {
    ...
    app.models.Note.find({author:req.params.username})
        .exec(function(err,allNotes){
            if(err)
            {
                console.log(err);
